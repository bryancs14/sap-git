		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Prueba Git Hub",
									"targetURL": "#combcuevasapruebagithub-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"combcuevasapruebagithub-display": {
								"semanticObject": "combcuevasapruebagithub",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.bcuevasa.pruebagithub",
									"url": sap.ui.require.toUrl("com/bcuevasa/pruebagithub")
								}
							}
						}
					}
